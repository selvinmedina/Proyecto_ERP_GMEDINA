namespace ERP_GMEDINA.Models
{
    ...
    public partial class ERP_GMEDINAEntities : DbContext
    {
        ...
        public virtual ObjectResult<UDP_Vent_tbCuponDescuento_Imprimir_Result1> UDP_Vent_tbCuponDescuento_Imprimir(Nullable<int> cdto_ID)
        {
            var cdto_IDParameter = cdto_ID.HasValue ?
                new ObjectParameter("cdto_ID", cdto_ID) :
                new ObjectParameter("cdto_ID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<UDP_Vent_tbCuponDescuento_Imprimir_Result1>("UDP_Vent_tbCuponDescuento_Imprimir", cdto_IDParameter);
        }
